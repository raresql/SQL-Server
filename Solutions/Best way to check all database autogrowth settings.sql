--Script Name: Best way to check all database autogrowth settings
--Script Type: Solution
--Article: https://raresql.com/2013/02/19/sql-server-best-way-to-check-all-database-autogrowth-settings/
