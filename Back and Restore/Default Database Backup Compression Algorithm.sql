--Script Name: Default Database Backup Compression Algorithm
--Script Type: Backup and Restore
--Article: https://raresql.com/2022/12/13/sql-server-2022-tsql-ms_xpress-default-database-backup-compression-algorithm/
